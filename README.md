...
> **TL;DR** — One-command ROS 2 Humble containerized dev environment. Auto-detects UID/GID/GPU, supports X11 GUI forwarding, multi-stage build with smoke test verification.
>
> ```bash
> ./build.sh && ./run.sh
> ```
